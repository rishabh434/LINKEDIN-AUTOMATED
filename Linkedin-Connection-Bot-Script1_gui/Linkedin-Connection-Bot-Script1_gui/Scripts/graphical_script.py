'''
Author - Rishabh Pratap Singh
Profile - Data Scientist AI
'''
...
constants.username = "anupamkapoor1901@gmail.com"
constants.password = "Anupam1234@@"
constants.commaseparated = "Field1;Field2;field3"
constants.upto_page = 2
...
def guibuild():
    ...
    link = "https://www.linkedin.com/in/rps434/"
    text = Text(root, height=1, padx=10, borderwidth=1, bg="cyan")
    text.insert(1.0, link)
    text.configure(state="normal")
