...
def configurations():
    ...
    driver = webdriver.Chrome(
        options=options, executable_path="C:/Users/iglgo/OneDrive/Desktop/Linkedin-Connection-Bot-Script1_gui/Linkedin-Connection-Bot-Script1_gui/ChromeDriver\chromedriver.exe")  # For mac use -> /usr/local/bin/chromedriver
